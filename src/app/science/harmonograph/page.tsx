...
/**
 * Sound Drawing - a sandbox under the existing Science hub (issue #225, wave 4).
 *
 ...
 * Sphere, Pattern Garden and Fractal Grower do.
 *
 * The chrome is dark for the same reason the last three are. This activity is a
...
export default function HarmonographPage() {
  return (
    ...
    <div
      ...
      style={{ height: 'calc(100dvh - 80px)', backgroundColor: '#0A1016' }}
    >
      <header
