...
export const REELS_DATA: Reel[] = [
  ...
  // SENSORY 3D GAMES
  {
    id: 120,
    type: "game",
    title: "Calming Particles",
    thumbnail: "/placeholder.svg?height=300&width=200&text=Particles",
    topics: ["sensory"],
    gameType: "calmingParticles3d",
  },
  {
    id: 121,
    type: "game",
    title: "Breathing Sphere",
    thumbnail: "/placeholder.svg?height=300&width=200&text=Breathe",
    topics: ["sensory"],
    gameType: "breathingSphere3d",
  },
  {
    id: 122,
    type: "game",
    title: "Crystal Garden",
    thumbnail: "/placeholder.svg?height=300&width=200&text=Crystal",
    topics: ["sensory", "colors"],
    gameType: "crystalGarden3d",
  },
  {
    id: 123,
    type: "game",
    title: "Starfield",
    thumbnail: "/placeholder.svg?height=300&width=200&text=Stars",
    topics: ["sensory"],
    gameType: "starfield3d",
  },
  {
    id: 124,
    type: "game",
    title: "Chain Reaction",
    thumbnail: "/placeholder.svg?height=300&width=200&text=Chain",
    topics: ["sensory", "colors"],
    gameType: "chainReaction3d",
  },
  {
    id: 125,
    type: "game",
    title: "Ball Run",
    thumbnail: "/placeholder.svg?height=300&width=200&text=BallRun",
    topics: ["sensory", "colors"],
    gameType: "ballRun3d",
  },
  {
    ...
    type: "game",
    title: "Lava Lamp",
    thumbnail: "/placeholder.svg?height=300&width=200&text=LavaLamp",
    topics: ["sensory", "colors"],
    gameType: "lavaLamp3d",
  },
  {
    ...
    thumbnail: "/placeholder.svg?height=300&width=200&text=Dominos",
    topics: ["sensory"],
    gameType: "dominoCascade3d",
  },
  {
    id: 128,
    type: "game",
    title: "Pendulum Wave",
    thumbnail: "/placeholder.svg?height=300&width=200&text=Pendulum",
    topics: ["sensory"],
    gameType: "pendulumWave3d",
  },
  {
    id: 129,
    type: "game",
    title: "Magnetic Particles",
    thumbnail: "/placeholder.svg?height=300&width=200&text=Magnetic",
    topics: ["sensory"],
    gameType: "magneticParticles3d",
  },
